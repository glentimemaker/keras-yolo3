...
class YOLO(object):
    _defaults = {
        "model_path": 'logs/coco/class_loss_1.5/ep086-loss17.602-val_loss18.029.h5',
    ...
    def detect_image(self, image, img_name):
        ...
        img_id = int(img_name.lstrip("0")[:-4])
        for i, box in enumerate(out_boxes):
            ...
            if cls in [0, 1, 2, 3, 4]:
                ...
                det_dict = {'image_id': img_id,
                            ...
                            'category_id': 3,
                            'bbox': list(map(float, [new_box[1], new_box[0], new_box[3], new_box[2]])),
                            'score': float(score)}
